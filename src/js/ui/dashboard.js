...
searchbar.addEventListener('keyup', () => {
  ...
  printText(totalCities,
      `Showing ${countCities(
          document.querySelectorAll('li.table-row'))} cities`,
  );
...
geoButton.addEventListener('click', () =>
  askLocation(map).then((pos) =>
    reverseSearchMap(pos.latitude, pos.longitude)));
...
delay(params.delay).then(() => {
  getDayAndCsv('https://dadesobertes.gva.es/api/3/action/package_search?q=id:5403e057-5b64-4347-ae44-06fa7a65e1b8')
      .then((json) => {
