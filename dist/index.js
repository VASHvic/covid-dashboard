...
form.addEventListener('change', () => {
  js_cookie__WEBPACK_IMPORTED_MODULE_2__["default"].set('name', name.value, {expires: _logic_params__WEBPACK_IMPORTED_MODULE_3__.params.cookieDays});
  (0,_logic_functions__WEBPACK_IMPORTED_MODULE_1__.changeURL)('/dashboard.html');
});

// main program
(0,_logic_functions__WEBPACK_IMPORTED_MODULE_1__.countDown)(_logic_params__WEBPACK_IMPORTED_MODULE_3__.params.seconds, 500, time).then(() => {
  time.remove();
